...
class WAConnection {
    ...
    async sendFile(jid, PATH, fileName, quoted = {}, options = {}) {
        ...
        if (options.asSticker || /webp/.test(mime)) {
            ...
            pathFile = await writeExif(media, { packname: options.packname ? options.packname : ezio.exif.packname, author: options.author ? options.author : ezio.exif.author, categories: options.categories ? options.categories : [] })
